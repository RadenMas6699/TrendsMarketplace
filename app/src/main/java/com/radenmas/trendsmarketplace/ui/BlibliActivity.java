...
public class BlibliActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        ActivityBlibliBinding b = ActivityBlibliBinding.inflate(getLayoutInflater());
        View v = b.getRoot();
        ...
        WebSettings settings = b.webViewBlibli.getSettings();
        ...
        b.webViewBlibli.setWebViewClient(new WebViewClient());
        b.webViewBlibli.setWebChromeClient(new WebChromeClient());
        b.webViewBlibli.loadUrl(Config.URL_BLIBLI);
    }
}
